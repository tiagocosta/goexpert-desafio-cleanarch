...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrdersList, error) {
	out := new(OrdersList)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*OrdersList, error) {
